...
import { TrafficConeIcon, HandCoins} from 'lucide-react';

export default function BudgetLineEntryPoint () {
        ...
        <div className='flex justify-normal md:justify-center items-start md:items-center m-4'>
            {
                ...
                isLoading ? (
                    ...
                    <div className='flex flex-col items-center space-y-2'>
                        ...
                        <p className='font-semibold text-xs text-center max-w-[70px]'>Ligne budgetaire</p>
                    </div>
                )
            }
