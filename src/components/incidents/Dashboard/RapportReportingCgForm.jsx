...
const RapportReportingCgForm = ({ onSubmit }) => {
    ...
    const generateReport = async () => {
        ...
        try {
            ...
            // ✅ URL corrigée vers la bonne route
            const url = `${URLS.INCIDENT_API}/reporting-cgs/export?${params.toString()}`;
            ...
            if (response.status === 200) {
                ...
                link.download = 'reporting-cg-export.xlsx';  // ✅ nom de fichier corrigé
                link.click();
                if (onSubmit) onSubmit();

            } else if (response.status === 404) {
                setError("Aucun reporting CG trouvé avec ces critères");
            } else {
...
export default RapportReportingCgForm;