...
const Datalist = ({ dataList, fetchData, searchValue, pagination, loading, onEdit,canEdit, references = {} }) => {
    ...
    const columns = [
        ...
        { title: "Créé le", dataIndex: "createdAt", width: 100, render: (v) => new Date(v).toLocaleDateString() },
        { title: "Quart", dataIndex: "shiftId", width: 120, render: (v) => getShiftName(v) },
        { title: "Site", dataIndex: "siteId", width: 90, render: (v) => getSiteName(v) },
        { title: "N° recette", dataIndex: "recipeCardNumber", width: 110 },
