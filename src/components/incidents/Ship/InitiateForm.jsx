  ...
  const submitForm = async (data) => {
    ...
    try {
      ...
      if (isEditMode && editData) {
        ...
        let url = `${URLS.INCIDENT_API}/ships/${editData.id}`;
        ...
        let url = `${URLS.INCIDENT_API}/ships`;
    ...
    <form onSubmit={handleSubmit(submitForm)} className='space-y-4'>
      <div className='flex flex-col space-y-2'>
        ...
        <input 
          ...
          placeholder="Entrer le nom du navire"
        ...
        >
          ...
          <span>
            {isSubmitting 
              ...
              : (isEditMode ? "Modifier le navire" : "Créer le navire")
            }
          </span>
        </Button>
      </div>
