...
//     const [incidentTypes, setIncidentTypes] = useState([]); // État local pour les options
...
//             if (response.error) {
//                 toast.error("Cette enregistrement existe déjà dans la base de données");
//                 return;
//             }
            
//             toast.success("Créé avec succès");
//             reset();
//             // Réinitialiser aussi la valeur de l'AutoComplete
//             setIncidentTypes([]);
//             onSucess();
//         } catch (error) {
//             console.log(error);
...
//                     onSearch={handleSearchIncidentTypes} // Sera appelé lors de la recherche
...
//             <Button 
//                 type="submit" 
//                 className="bg-primary text-white font-normal py-2 w-full"
//             >
//                 Créer
//             </Button>
//         </form>
